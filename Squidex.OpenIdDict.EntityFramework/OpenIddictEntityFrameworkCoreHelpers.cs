...
public static class OpenIddictEntityFrameworkCoreHelpers
{
    ...
    public static DbContextOptionsBuilder UseOpenIddict(this DbContextOptionsBuilder builder)
        => builder.UseOpenIddict<OpenIddictEntityFrameworkCoreAuthorization,
    ...
    public static DbContextOptionsBuilder UseOpenIddict<TKey>(this DbContextOptionsBuilder builder)
        ...
        => builder.UseOpenIddict<OpenIddictEntityFrameworkCoreAuthorization<TKey>,
    ...
    /// <see cref="OpenIddictEntityFrameworkCoreBuilder.ReplaceDefaultEntities{TAuthorization, TToken, TKey}"/>.
    /// </remarks>
    /// <param name="builder">The builder used to configure the Entity Framework context.</param>
    /// <returns>The Entity Framework context builder.</returns>
    public static DbContextOptionsBuilder UseOpenIddict<TAuthorization, TToken, TKey>(
    ...
    /// <param name="builder">The builder used to configure the Entity Framework context.</param>
    /// <returns>The Entity Framework context builder.</returns>
    public static DbContextOptionsBuilder<TContext> UseOpenIddict<TAuthorization, TToken, TKey, TContext>(
        ...
        where TContext : DbContext
    {
        builder.UseOpenIddict<TAuthorization, TToken, TKey>();
        return builder;
    }
    ...
    /// <param name="builder">The builder used to configure the Entity Framework context.</param>
    /// <returns>The Entity Framework context builder.</returns>
    public static ModelBuilder UseOpenIddict<TAuthorization, TToken, TKey>(this ModelBuilder builder)
        where TAuthorization : OpenIddictEntityFrameworkCoreAuthorization<TKey, TToken>
        where TToken : OpenIddictEntityFrameworkCoreToken<TKey, TAuthorization>
        where TKey : notnull, IEquatable<TKey>
    {
        ...
        return builder
            .ApplyConfiguration(new OpenIddictEntityFrameworkCoreAuthorizationConfiguration<TAuthorization, TToken, TKey>())
            .ApplyConfiguration(new OpenIddictEntityFrameworkCoreTokenConfiguration<TToken, TAuthorization, TKey>());
    }
